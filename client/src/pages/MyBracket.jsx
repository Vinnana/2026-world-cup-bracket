...
function KoCard({ match, scorePick, result, locked, onSaveScore, onClearScore, homeTeam, awayTeam, predictedHomeTeam, predictedAwayTeam, advancePick, onPickAdvancement, matchupOk = true }) {
